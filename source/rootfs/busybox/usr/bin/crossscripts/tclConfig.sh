...
TCL_CC='arm-poky-linux-gnueabi-gcc  -march=armv7ve -mfpu=neon  -mfloat-abi=hard -mcpu=cortex-a7 --sysroot=/home/linuxdzm/alientek_workspace/ycoto/fsl-release-bsp/buildQt5.12.9/tmp/sysroots/imx6ull14x14evk'
...
TCL_EXTRA_CFLAGS=' -O2 -pipe -g -feliminate-unused-debug-types -fdebug-prefix-map=/usr/include=/usr/src/debug/tcl/8.6.4-r0 -fdebug-prefix-map=/home/linuxdzm/alientek_workspace/ycoto/fsl-release-bsp/buildQt5.12.9/tmp/sysroots/x86_64-linux= -fdebug-prefix-map=/home/linuxdzm/alientek_workspace/ycoto/fsl-release-bsp/buildQt5.12.9/tmp/sysroots/imx6ull14x14evk=  -pipe '
...
TCL_RANLIB='arm-poky-linux-gnueabi-ranlib'
